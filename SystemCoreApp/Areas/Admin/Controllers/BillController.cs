...
using SystemCore.Utilities.Extensions;
...
namespace SystemCoreApp.Areas.Admin.Controllers
{
    public class BillController : BaseController
    {
        ...
        {
            var data = _billService.GetDetail(id);
        ...
        public IActionResult GetColors()
        {
            ...
            return new ObjectResult(colors);
        }
        ...
        public IActionResult ExportExcel(int billId)
        {
            ...
            string url = $"{Request.Scheme}://{Request.Host}/{"exportFile"}/{sFileName}";
            FileInfo file = new FileInfo(Path.Combine(sWebRootFolder, "exportFile", sFileName));
            if (file.Exists)
            {
                file.Delete();
