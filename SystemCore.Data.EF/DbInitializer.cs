...
namespace SystemCore.Data.EF
{
    public class DbInitializer
    {
        ...
        public DbInitializer(AppDbContex appDbContex, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
        ...
        public async Task Seed()
        {
            ...
            if(_appDbContex.Functions.Count() == 0)
            {
                _appDbContex.Functions.AddRange(new List<Function>
                {
            ...
            if (_appDbContex.Footers.Count(x => x.Id == CommonConstants.DefaultFooterId) == 0)
            {
                string content = "Footer";
                _appDbContex.Footers.Add(new Footer()
                {
            ...
            if (_appDbContex.Colors.Count() == 0)
            {
            ...
            if (_appDbContex.Slides.Count() == 0)
            {
            ...
            {
                _appDbContex.SystemConfigs.Add(new SystemConfig()
                {
                    Id = "HomeTitle",
